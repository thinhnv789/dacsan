             ...
             <table class="lang-list-item" class="admintable" width = "50%" >    
                 <?php $k=0; foreach($this->langoverlist as $langol) { $k++; ?>
                    <tr id="" class="lang-item-tr<?php echo $k; ?>">
                      <td class="key">
                        <input type = "text" class = "inputbox" name = "<?php print $name?>[]" value = "<?php echo $langol["$name"]; ?>" />
                      </td>
                      <td class="key">
                        <input style="width:500px;" type = "text" class = "inputbox" name = "<?php print $description?>[]" value = "<?php echo $langol["$description"]; ?>" />
                      </td>
                      <td class="key">
                          <a class="delete-lang-item icon-unpublish" href="#">&nbsp;</a> 
                      </td>
                    </tr>   
                <?php } ?>
             </table>
...
<div style="margin-top:10px;;"> 
    <a id="add-lang-item" class="icon-new" href="#">&nbsp;</a>
</div>
...
<table style="display:none;">
    <tr id="lang-item-tr" class="lang-item-tr">
      ...
      <td class="key">
        <input type="text" class="inputbox desc" style="width:500px;" />
      </td>
      <td class="key">
          <a class="delete-lang-item icon-unpublish" href="#">&nbsp;</a> 
      </td>
