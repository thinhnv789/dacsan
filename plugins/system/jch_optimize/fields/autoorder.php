...
else
{
        ...
        class JFormFieldAutoorder extends JFormFieldAuto
        {
                ...
                protected function getButtons()
                {
                        ...
                        $aButtons[4]['text']    = 'Order Plugin';
                        $aButtons[4]['script']  = '';
                        $aButtons[4]['class']   = 'enabled';
                        $aButtons[4]['tooltip'] = 'The published order of the plugin is important! When you click on this icon, it will attempt to order the plugin correctly.';
