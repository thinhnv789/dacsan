...
class modVinaTickerJShoppingHelper
{
/* Get Products */
	public static function getItems($params)
	{
		...
		{
			case "1":
				$items = modVinaTickerJShoppingHelper::getBestSeller($params);
			break;
			case "3":
				$items = modVinaTickerJShoppingHelper::getTopHits($params);
			break;
			case "4":
				$items = modVinaTickerJShoppingHelper::getTopRating($params);
			break;
			default:
				$items = modVinaTickerJShoppingHelper::getLatest($params);
			break;
		}
