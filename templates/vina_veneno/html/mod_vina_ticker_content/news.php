					...
					<div class="span<?php echo (!empty($image) && $showImage) ? 8 : 12; ?>">
						<div class="text-block">
							...
							<div class="info">
								...
								<span class="info-item"><i class="icon-time"><b>Time</b></i> <span class="color"><?php echo substr(JHTML::_('date', $created, 'F'),0,3);?> <?php echo JHTML::_('date', $created, 'd, Y');?> </span></span>
								<?php endif; ?>
								
								<?php if($showCategory) : ?>
								<span class="info-item"><?php echo JTEXT::_('VINA_CATEGORY'); ?>: <?php echo $category; ?></span>
								<?php endif; ?>
								
								<?php if($showHits) : ?>
								<span class="info-item"><i class="icon-eye-open"><b>Hits</b></i> <span class="color"><?php echo $hits; ?> times</span></span>
								<?php endif; ?>
							</div>
							<?php endif; ?>
