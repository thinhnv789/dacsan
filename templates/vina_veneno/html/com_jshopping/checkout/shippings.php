...
<table id = "table_shippings" class="cellspacing cellpadding">
...
<button type = "submit" class = "btn btn-primary vina-button" value = "<?php print _JSHOP_NEXT ?>">
	<span><span><?php print _JSHOP_NEXT ?></span></span>
</button>
</form>
</div>
</div>
