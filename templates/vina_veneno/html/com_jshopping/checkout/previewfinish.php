...
<div class="jshop-place-order">
    ...
    <form class="jshop-place" name = "form_finish" action = "<?php print $this->action ?>" method = "post">
       <table class = "jshop" style="width:auto;margin-left:auto;margin-right:auto;text-align: center;">
         <!--<tr>
           <td>
