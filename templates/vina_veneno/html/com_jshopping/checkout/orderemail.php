...
<?php if ($this->show_customer_info){?>
  <tr><td style="height:10px;font-size:1px;">&nbsp;</td></tr>
  <tr class="bg_gray">
    <td colspan="2" class="colWidth50">
       <h3><?php print _JSHOP_CUSTOMER_INFORMATION?></h3>
    </td>
  </tr>
  <tr>
    <td  style="vertical-align:top;padding-top:10px;" class="colWidth50">
      <table cellspacing="0" cellpadding="0" style="line-height:100%;">
        ...
        <tr>
          <td class="colWidthpx100"><?php print _JSHOP_FIRMA_NAME?>:</td>
          <td><?php print $this->order->firma_name?></td>
        </tr>
        <?php } ?>
        <?php if ($this->config_fields['f_name']['display']){?>
        <tr>
          <td class="colWidthpx100"><?php print _JSHOP_FULL_NAME?>:</td>
    ...
    <table cellspacing="0" cellpadding="0" style="line-height:100%;">
        ...
        <tr>
          <td class="colWidthpx100"><?php print _JSHOP_REG_TITLE?>:</td>
    ...
    <td colspan="2" style="padding:0px;padding-top:10px;">
       <table width="100%" cellspacing="0" cellpadding="0" class="table_items">
        <tr><td colspan="5" style="vertical-align:top;padding-bottom:5px;font-size:1px;"><div style="height:1px;border-top:1px solid #999;"></div></td></tr>
         <tr class = "bold">            
            <td class="colWidth45" style="padding-left:10px;padding-bottom:5px;"><?php print _JSHOP_NAME_PRODUCT?></td>            
            <td class="colWidth45" style="padding-bottom:5px;"><?php if ($this->config->show_product_code_in_order){?><?php print _JSHOP_EAN_PRODUCT?><?php } ?></td>
            <td class="colWidth45" style="padding-bottom:5px;"><?php print _JSHOP_QUANTITY?></td>
            <td class="colWidth45" style="padding-bottom:5px;"><?php print _JSHOP_SINGLEPRICE?></td>
            <td class="colWidth45" style="padding-bottom:5px;"><?php print _JSHOP_PRICE_TOTAL?></td>
         </tr>
