  ...
  <tr class="jshop_prod_cart <?php if ($i%2==0) print "even"; else print "odd"?>">
    ...
    <td>
		<span class="jshop_price">
			<span><?php print formatprice($prod['price'])?>
    ...
    <td>
      <a href="<?php print $prod['href_delete']?>" onclick="return confirm('<?php print _JSHOP_CONFIRM_REMOVE?>')"><i style="display: inline-block; font-size: 18px; color: #ff1a1a;" class="icon-remove"></i></a>
    </td>
  </tr>
  <?php 
  $i++;
...
<table class="jshop activate-code">
  <tr>
    <td>
